...
def manual():
    ...
    time.sleep(print_delay)
    print("3) If sum of the cards is > 21 casino/player loses the round")
    time.sleep(print_delay)
    print("4) If the sum of the cards is 21,the casino/player wins the round.")
    time.sleep(print_delay)
    print("5) If sum < 21 for both players and noone wants to take additional")
    print("card, we compare the sums of the participants to determine winner.")
    time.sleep(print_delay)
    ...
    time.sleep(print_delay)
    print("casino takes additional card.  If the above")
    time.sleep(print_delay)
    print("statement is not true, casino does not take any additional card.")
    time.sleep(print_delay)
    input(Fore.YELLOW + "To start a game please press any key")
